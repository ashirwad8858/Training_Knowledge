...
seed_examples:
  - context: |
      *Alex Rivera is a seasoned mechanical engineer based in San Francisco,
      with over a decade of experience in the automotive and electric mobility industry.
      Currently, he holds a senior position at MechaTech Industries,
      where he leads a cross-functional team responsible for designing
      next-generation electric vehicle (EV) propulsion systems.
      His innovative work has contributed to several patent-pending designs aimed at improving battery efficiency
      and thermal management. He is also a mentor for junior engineers and a regular speaker at EV technology conferences.
    questions_and_answers:
      - question: |
          What specific area of engineering does Alex specialize in?
        answer: |
          He specializes in mechanical engineering with a focus on electric vehicle propulsion systems.
      - question: |
          What notable achievements has Alex had in his engineering career?
        answer: |
          He has contributed to several patent-pending EV propulsion designs
          and speaks at technology conferences.
      - question: |
          What is Alex's current professional role
        answer: |
          He is a senior mechanical engineer leading a cross-functional EV design team at MechaTech Industries.
  - context: |
